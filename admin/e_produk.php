    ...
    if(isset($_POST['simpan'])) {
        ...
        if ($_FILES['gambar']['name'] != '') {
            ...
            if (!in_array($extensions, $allowed_extensions)) {
                ...
                $imgnewfile = $gambar_lain; //gunakan gambar lain jika tidak ada gambar baru
            }
            ...
            echo "<script>alert('Gagal memupdate  data produk!');</script>";
            header("refresh:0, produk.php");
            }
        }
?>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Reina Nest</span>
            </a>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 mt-2" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="nm_produk" name="nm_produk" placeholder="Masukkan Nama Produk" value="<?php
                                    echo $data['nm_produk']; ?>" required>
                                </div>
                                <div class="col-12">
                                    <label for="harga" class="form-label">Harga</label>
                                    <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Produk" value="<?php
                                    echo $data['harga']; ?>" required>
                                </div>
                                <div class="col-12">
                                    <label for="stok" class="form-label">Stok</label>
                                    <input type="number" class="form-control" id="stok" name="stok" placeholder="Masukkan Stok Produk" value="<?php
                                    echo $data['stok']; ?>" required>
                                </div>
                                <div class="col-12">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>ReinaNest</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="https://www.instagram.com/yawaa_kutori"
