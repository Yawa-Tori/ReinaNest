...
<head>
    ...
    <title>Keranjang - ReinaNest Admin</title>
    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                      ...
                      //query untuk mengambil data penjulan dengan filter kategori jika ada
                                ...
                                <form class="filter-form d-flex align-items-center" method="GET" action="">
                                  <select name="kategori" class="form-select me-2" style="max-width: 200px;" title="Pilih Kategori">
                                    ...
                                    if ($result_kategori->num_rows > 0) {
                                      ...
                                      echo "<option value='" . $row['id_kategori'] . "' $selected>" . htmlspecialchars($row['nm_kategori']) . 
                                      "</option>";
                                      }
                                    }
                                    ?>
                                    </select>
                                  <button button type="submit" class="btn btn-primary ms-2">Filter</button>
                                </form>
                              </div> <!-- end filter bar-->       
                            </div>
                          </div>
