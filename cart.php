...
<head>
  ...
  <title>Keranjang - Reina Nest</title>
    ...
    <div class="container">
      <div class="cart_inner">
        <div class="table-responsive">
          <?php 
          include 'admin/koneksi.php'; //pastikan koneksi ke databse dimuat
                    ...
                    <form action="update_cart.php" method="POST">
                      <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="product_count">
                                  ...
                                  <input class="input-number" type="number" name="qty[<?php echo
                                  $row['id_pesanan']; ?>]" value="<?php echo $row['qty'];
                                  ?>" min="1">
                              ...
                              <td>
                                ...
                                ['id_pesanan']; ?>" class="btn btn-danger btn-sm"
                          ...
                          <?php
                          $diskon = 0;
                          if ($subtotal > 70000 && $subtotal <= 1500000) {
                          ...
                          <tr>
                            ...
                            <td style="text-align: right;">
                              <h5>Rp. <?php echo number_format($total_bayar, 0, ',', '.'); ?>
                              </h5>
                            </td>
