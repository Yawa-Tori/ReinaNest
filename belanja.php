...
<head>
    ...
    <title>Belanja - Reina Nest</title>
    ...
    <style>
        ...
        .product_img_wrapper img {
            width: 100%;
            height: 100%;
            /*crop gambar agar tetap proposional*/
            border-radius: 10px;
        }
        .cart-badge {
            position: absolute;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="left_sidebar_area">
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            <?php
                            include 'admin/koneksi.php'; // pasltikan file koneksi ada
                ...
                <div class="col-lg-9">
                    ...
                    <?php
                    //tentukan jumlah profuk per halaaman
                    $limit = 6;
                    ...
                    //query produk dengan filter kategori dan pencraian
