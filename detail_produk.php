...
<head>
  ...
  <title>Detail Produk - Reina Nest</title>
...
<body>
  ...
  //pastikan ada paramater id_produk yang dikirim dari URL
  ...
  //tambahan pesanan ke database
  if (isset($_POST['add_to_cart'])) {
    if (!isset($_SESSION['login'])) {
      echo "<script>alert('Silakan login terlebih dahulu!'); window.location.href='login'.php;
      </script>";
    } else {
      ...
      //cek stok langsung dari databasee (lebih aman)
      ...
      if ($qty > $data_stok['stok']) {
        ...
        //buat id_pesanan otomatis denhan format M001, M002, dst
        ...
        $new_id = "M001"; // jka belum ada pesanan, mulai dari M001  
        }
            ...
            <?php while ($produk_lain = $result_produk_lain->fetch_assoc()) { ?>
              <div class="single_product_item">
                ...
                <div class="single_product_text">
                  ...
                  <h3>Rp <?php echo number_format($produk_lain['harga'], 0, ',', ','); ?>
                  </h3>
